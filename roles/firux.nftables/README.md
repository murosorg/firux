...
[![Ansible Galaxy](https://badges.oss.oxl.app/galaxy.badge.svg)](https://galaxy.ansible.com/ui/standalone/roles/firux/nftables)
...
# from galaxy
ansible-galaxy install firux.nftables

# or to custom role-path
ansible-galaxy install firux.nftables --roles-path ./roles
```
...
* **Info:** You can add **DNS-Resolution and IP-Blocklist** functionalities to NFTables using the [firux.nftables_addons](https://github.com/O-X-L/ansible-role-nftables-addons) role!
